...
# ✅ FIX: use product_name instead of product_id
total_products  = filt["product_name"].nunique()

avg_reorder     = filt["reordered"].mean()

# ✅ FIX: basket using product_name
avg_basket = filt.groupby("order_id")["product_name"].count().mean()
